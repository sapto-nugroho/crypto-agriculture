...
def generate_rsa_keys():
    ...
    print("[KEY] RSA-2048 keys generated.")
...
def generate_ecc_keys():
    ...
    print("[KEY] ECC X25519 keys generated.")
...
def store():
    ...
    try:
        ...
        # Kembalikan dec_ms ke gateway/experiment
        return jsonify({"status": "ok", "seq": seq, "dec_ms": dec_ms})
